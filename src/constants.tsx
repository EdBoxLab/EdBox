...
import type { Section, Extension } from './app/ide/types';
...
export const SAMPLE_EXTENSIONS: Extension[] = [
    { id: 'html-preview', name: 'HTML Live Previewer', description: 'Renders a live preview of HTML files in the interactive canvas.', publisher: 'EdBox', installed: true, icon: '📱' },
    { id: 'css-injector', name: 'CSS Hot-Reloader', description: 'Automatically applies CSS changes to the live preview without a full page reload.', publisher: 'EdBox', installed: true, icon: '🎨' },
    { id: 'js-runner', name: 'JavaScript Runner', description: 'Executes JavaScript code in the context of the live preview canvas.', publisher: 'EdBox', installed: true, icon: '⚙️' },
    { id: 'physics-visualizer', name: 'Physics Canvas Visualizer', description: 'Visualizes physics simulations from the Physics Engine on the interactive canvas.', publisher: 'EdBox Labs', installed: false, icon: '🔬' },
    { id: 'molecule-renderer', name: '3D Molecule Renderer', description: 'Renders chemical formulas and reactions as interactive 3D models.', publisher: 'Community', installed: false, icon: '🧪' },
];
